...
- 📧 **Rich HTML templates** using Blade
- 🎨 **Markdown email components** for quick styling
- 📎 **Attachments** (PDFs, invoices, etc.)
- 🧪 **Easy testing** with Mail fakes
...
- **[Notifications →](/packages/notifications)** - Learn about notification channels
- **[Events & Listeners →](/extending/events)** - Trigger emails from events
