...
<template>
  <AdminLayout title="Subscriptions">
    <template #header>
      <CPageHeader>
        <CPageTitle>Subscriptions</CPageTitle>
        <template #actions>
          <CButton
  ...
  <CCard>
    <CCardHeader>
      <div class="flex items-center justify-between">
        <div>
          <CCardTitle>{{ subscription.plan.name }}</CCardTitle>
          <CCardDescription>
...
<template>
  <AdminLayout title="Create Subscription">
    <CCard>
      <CCardHeader>
        <CCardTitle>New Subscription</CCardTitle>
      </CCardHeader>

      <form @submit.prevent="submit">
        <CCardContent class="space-y-4">
          <CFormGroup
            label="Customer"
        ...
        <CCardFooter class="flex justify-end gap-2">
          <CButton
            variant="outline"
            :href="route('subscriptions.index')"
          >
