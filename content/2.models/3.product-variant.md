...
description: ProductVariant model reference
...
```php
use Cartino\Events\VariantCreated;
use Cartino\Events\VariantUpdated;
use Cartino\Events\VariantInventoryChanged;
