...
title: Order
description: Order model reference
...
{
    $prefix = config('cartino.order_number_prefix', 'ORD');
    $year = date('Y');
...
use Cartino\Events\OrderPaid;
use Cartino\Events\OrderShipped;
use Cartino\Events\OrderCompleted;
use Cartino\Events\OrderCancelled;
use Cartino\Events\OrderRefunded;
