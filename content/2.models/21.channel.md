...
title: Channel
description: Channel model reference
...
```php
use Cartino\Events\ChannelCreated;
use Cartino\Events\ChannelUpdated;
use Cartino\Events\ChannelActivated;
