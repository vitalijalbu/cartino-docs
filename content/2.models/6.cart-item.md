...
title: CartItem
description: CartItem model reference
...
```php
use Cartino\Events\CartItemAdded;
use Cartino\Events\CartItemUpdated;
use Cartino\Events\CartItemRemoved;
