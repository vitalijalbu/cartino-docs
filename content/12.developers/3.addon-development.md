...
- 📦 **Package functionality** - Self-contained, installable packages
- 🔌 **Hook into core** - Extend models, controllers, routes
- 🎨 **Add admin UI** - Custom pages, components, widgets
- 🗄️ **Manage data** - Migrations, seeders, models
- ⚙️ **Provide settings** - Configurable via admin
- 📝 **Include documentation** - README and guides
- 🧪 **Include tests** - PHPUnit and Pest tests
